...
const beamSteps: ExplainerPage[] = [
  {
    ...
    // titleSquircle: true,
    mdContent: `
**Beam** is a chat modality in com-chat to engage multiple AI models, [together](https://comchat.ai/blog/beam-multi-model-ai-reasoning). 
...
![com-chat BEAM Rays](https://raw.githubusercontent.com/smart-window/com-chat/main/public/images/explainers/explainer-beam-scatter-1200px-alpha.png)
...
![com-chat BEAM Rays](https://raw.githubusercontent.com/smart-window/com-chat/main/public/images/explainers/explainer-beam-gather-1600px-alpha.png)
...
// There are profound reasons why this approach works, which we explore [in our blog](https://comchat.ai/blog/introducing-beam).
//
// #### Best Use
