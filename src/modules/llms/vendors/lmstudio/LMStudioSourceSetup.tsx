...
export function LMStudioSourceSetup(props: { sourceId: DModelSourceId }) {
  ...
  return <>
    ...
    <Typography level='body-sm'>
      ...
      level='body-sm' href='https://github.com/smart-window/com-chat/blob/main/docs/config-local-lmstudio.md' target='_blank'>configuration guide</Link> for
    ...
    <FormInputKey
      ...
      required noKey
      rightLabel={<Link level='body-sm' href='https://github.com/smart-window/com-chat/blob/main/docs/config-local-lmstudio.md' target='_blank'>Learn more</Link>}
