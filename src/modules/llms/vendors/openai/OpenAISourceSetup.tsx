...
export function OpenAISourceSetup(props: { sourceId: DModelSourceId }) {
  ...
  const needsUserKey = !defaultCheck && !ModelVendorOpenAI.hasBackendCap?.();
  ...
  return <>
    ...
    <SetupFormRefetchButton defaultCheck={defaultCheck} refetch={refetch} disabled={isFetching} error={isError} advanced={advanced} />
